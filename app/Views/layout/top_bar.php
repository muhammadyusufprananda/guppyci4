  ...
  <section class="S-top-bar py-2">
    <div class="container">
      <div class="row">
        <!-- Bagian kontak -->
        <div class="col-6">
          <a href="mailto:amanullahmachfud@gmail.com"><i class="bi-envelope-fill me-1"></i>amanullahmachfud@gmail.com</a>
          <a href="#"><i class="bi-telephone-fill me-1"></i>081391453763</a>
        </div>
